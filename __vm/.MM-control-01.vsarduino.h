/* 
	...
	Hardware: Original Prusa i3 MK3 Multi Material 2.0 upgrade, Platform=avr, Package=PrusaResearch
*/
...
#define ARDUINO_AVR_prusa_mm_control
#define ARDUINO_ARCH_AVR
#define USB_VID 0x2c99
